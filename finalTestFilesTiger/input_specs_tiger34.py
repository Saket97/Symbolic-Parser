...
def specs():
	...
	accept_string = [ ' id let function id ( id : id , id : id ) : / id = ( id ( id + integer ) ; integer ) var id := integer function id ( id : id ) : id = ( id ( id , string ) ; string ) in id ( integer , string ) end ' ]
	reject_strings = ["let"]
