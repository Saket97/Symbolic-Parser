...
def specs():
	...
	accept_string = [ ' let type id = array of id type id = { id : id , id : id } var id := ] id { id = string type id = integer } var id := id [ integer ] of integer in if id <> id then integer else integer end ' ]
	reject_strings = ["let"]
