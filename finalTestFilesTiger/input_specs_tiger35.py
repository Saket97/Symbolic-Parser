...
def specs():
	...
	accept_string = [ ' let function id ( id : id , id : id ) string : id = ( id ( id + integer ) ; integer ) var id := integer function id ( id : id ) then : id = ( id ( id , string ) ; string ) in id ( integer , string ) end ' ]
	reject_strings = ["let"]
