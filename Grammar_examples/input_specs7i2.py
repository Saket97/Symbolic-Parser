...
def find_original_grammar():
	...
	original_grammar = [['S','a','A','B','b'], ['A','eps','a','A','c'], ['A','eps','eps','eps','d'], ['B','eps','eps','c','B'],['B','eps','eps','eps','c']]
	# return get_original_grammar()
	return original_grammar

def get_parse_table():
	parse_table = [{'non_term':'S' ,'a':1 ,'b':0 ,'c': 0,'d':0 ,'$':0 },{'non_term':'A' ,'a':2 ,'b':0 ,'c':0 ,'d':3 ,'$':0 },{'non_term':'B' ,'a':0 ,'b':0 ,'c':4 ,'d':0 ,'$':0 }]
	return parse_table
...
def get_first_set():
	first_set = [{'non_term':'S' ,'a':1 ,'b':0 ,'c':0 ,'d':0 ,'eps':0},{'non_term':'A' ,'a':1 ,'b':0 ,'c': 0,'d':1 ,'eps':0},{'non_term':'B' ,'a':0 ,'b':0 ,'c':1 ,'d':0 ,'eps':0}]
	return first_set

def get_follow_set():
	follow_set = [{'non_term':'S' ,'a':0 ,'b':0 ,'c':0 ,'d':0 ,'$':1},{'non_term':'A' ,'a':0 ,'b':0 ,'c':1 ,'d':0 ,'$':0},{'non_term':'B' ,'a':0 ,'b':1 ,'c':0 ,'d':0 ,'$':0}]
	return follow_set
